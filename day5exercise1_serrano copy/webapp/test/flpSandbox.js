		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbtpday5exercise1serrano-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise1serrano-display": {
								"semanticObject": "zbtpday5exercise1serrano",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise1serrano",
									"url": sap.ui.require.toUrl("zbtp/day5exercise1serrano")
								}
							}
						}
					}

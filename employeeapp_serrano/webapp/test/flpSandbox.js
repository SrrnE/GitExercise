		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee App",
									"targetURL": "#sapipstrainingemployeeappserrano-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingemployeeappserrano-display": {
								"semanticObject": "sapipstrainingemployeeappserrano",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.employeeappserrano",
									"url": sap.ui.require.toUrl("sapips/training/employeeappserrano")
								}
							}
						}
					}

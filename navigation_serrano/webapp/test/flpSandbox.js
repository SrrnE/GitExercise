		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#navigationserrano-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigationserrano-display": {
								"semanticObject": "navigationserrano",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationserrano",
									"url": sap.ui.require.toUrl("navigationserrano")
								}
							}
						}
					}
